package com.alexmls.echojournal.app.widget
...
import com.alexmls.echojournal.app.MainActivity
import com.alexmls.echojournal.app.navigation.ACTION_CREATE_ECHO
                    ...
                    modifier = GlanceModifier
                        .clickable {
                            val intent = Intent(context, MainActivity::class.java).also {
                                it.data = "https://echojournal.com/echo/true".toUri()
