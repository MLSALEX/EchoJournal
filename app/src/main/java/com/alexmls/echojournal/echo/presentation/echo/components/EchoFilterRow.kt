...
import com.alexmls.echojournal.core.presentation.designsystem.chips.MultiChoiceChip
...
import com.alexmls.echojournal.echo.presentation.echo.EchoAction
...
fun EchoFilterRow(
    ...
    FlowRow(
        ...
        MultiChoiceChip(
            ...
            onClick = {
                onAction(EchoAction.OnMoodChipClick)
            },
            leadingContent = {
